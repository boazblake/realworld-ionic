  ...
  return {
    view: function view(_ref2) {
      ...
      return m("ion-menu[type='push']", {
        ...
        // },
        contentId: contentId
      }, [m("ion-header", m("ion-toolbar", m("ion-title", title))), m("ion-content", contents)]);
    }
  };
};
...
var toProfilePage = function toProfilePage(mdl) {
  ...
  return {
    view: function view(_ref) {
      var _ref$attrs = _ref.attrs,
          mdl = _ref$attrs.mdl,
          side = _ref$attrs.side;
      return m("ion-list", [m(_components.ProfileLink, {
        mdl: mdl
      }), m("ion-item", m(_components.MenuToggle, {
        mdl: mdl,
        side: "start",
      ...
      }), mdl.state.darkmode ? "Day" : "Night")), m("ion-item", m(_components.TagList, {
        mdl: mdl
      }))]);
    }
  };
...
var Home = function Home() {
  ...
  return {
    ...
    view: function view(_ref4) {
      var mdl = _ref4.attrs.mdl;
      return [// m("ion-content", { id: "profile", contentId: "profile" }, [
      !mdl.state.isLoggedIn() && state.pageStatus == "loading" || state.feedStatus == "loading" && m(_components.Loader, [m("h1.logo-font", "Loading Data")]), state.pageStatus == "error" && m("ion-text", {
        color: "earning"
      }, m("h1", "Error Loading Data: ".concat(state.error))), state.pageStatus == "success" && [m(_components.FeedNav, {
